...
from JPG_Decoder.consts import *
from JPG_Decoder.bit_reader import BitReader
from JPG_Decoder.bmp_reader import save_bmp

from JPG_Decoder.zigzag import inverse_zigzag_single
...
class JPGImage:
            ...
            while i < 64:
                ...
                if ac_symbol == 0x00:
                    ...
                    if coeff_len > 0:
                        ...
                        i += 1
                        interval+=coeff_len
            self.DC_interval.append(interval)
    ...
    def save(self,lasf_pref=""):
        ...
        save_bmp(data,lasf_pref=lasf_pref)
